...
public:
  ...
  void plotSurfaceShapes(const std::string& options = "layers",const std::string& variable="", const std::string& saveName = "");
...
private : 
  ...
  void plotSS(const std::string& options = "layers",const std::string& variable="", const std::string& saveName = "");
  ...
  TH1* multiplyXaxis(const TH1 *h, double factor = 10000.0);
